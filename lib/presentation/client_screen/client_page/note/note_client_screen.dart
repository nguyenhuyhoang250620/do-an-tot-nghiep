        ...
        child: Column(
          children: [
            ...
            Expanded(
                flex: 9,
                child: Obx(
                  () => clientController.isLoadingNote.value
                      ? clientController.listNoteRequest.value.isNotEmpty
                          ? GridView.builder(
                              itemCount:
                                  clientController.listNoteRequest.length,
                              gridDelegate:
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        'assets/images/note_icon_image.png',
                                        fit: BoxFit.contain,
                                      ),
                                      SizedBox(
                                        height: 10,
                                      ...
                                      CustomRichText(
                                        textLeft: 'Trạng thái : ',
                                        textRight:
                                            '${clientController.listNoteRequest[index].status}',
                                      ),
                                      SizedBox(
                                        height: 10,
                                      ),
    ...
    content: Container(
      ...
      child: ListView(
        children: [
          ...
          Obx(
            () => controller.selectDateTime.value == '1 Ngày'
          ...
          Container(
            ...
            child: CustomDropDownButton(
              ...
              items: controller.listTypeNote
                  .map((e) => _childDropDownItem(e))
                  .toList(),
