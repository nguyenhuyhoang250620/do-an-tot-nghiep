...
class ConfigState extends State<ConfigManagement> {
            ...
            children: [
              ...
              Container(
                ...
                child: CustomDropDownButton(
                  ...
                  items: controller.getTeacherList
                      .map((e) => _childDropDownItem(e.TenGV!, e.MaGV!))
                      .toList(),
              ...
              Container(
                ...
                child: CustomDropDownButton(
                  ...
                  items: controller.getDepartmentList
                      .map((e) => _childDropDownItem(e.TenDV!, e.MaDV!))
                      .toList(),
                  onChangedlistSelect: (p0) {
              ...
              Container(
                ...
                child: CustomDropDownButton(
                  ...
                  items: controller.getClassList
                      .map((e) => _childDropDownItem(e.TenPhong!, e.MaPhong!))
                      .toList(),
                  onChangedlistSelect: (p0) {
              ...
              Container(
                ...
                child: CustomDropDownButton(
                  ...
                  items: controller.getShiftList
                      .map((e) => _childDropDownItem(e.TenCa!, e.MaCa!))
                      .toList(),
                  onChangedlistSelect: (p0) {
              ...
              Container(
                ...
                child: CustomDropDownButton(
                  ...
                  items: controller.getSubjectList
                      .map((e) =>
                          _childDropDownItem(e.TenHocPhan!, e.MaHocPhan!))
                      .toList(),
                  onChangedlistSelect: (p0) {
                    configController.ma_hoc_phan.value = p0 as String;
                    controller.getSubjectList.map((element) {
                      if (element.MaHocPhan ==
  ...
  Widget _deleteItem(List<ConfigModel> item, int index) {
    return Container(
      height: 100,
      width: 100,
      child: AlertDialog(
          ...
          CustomButtonAlert(
            ...
            onPressedEnable: () {
              configController.deleteConfig(
                  item[index].maGV, item[index].mahocphan.MaHocPhan!);
              Get.back();
            },
          )
        ],
  ...
  Widget viewBuild(List<ConfigModel> item, int index) {
    return AlertDialog(
      title: Center(
        ...
        children: [
          Text(
            "Thông tin chi tiết điểm danh",
            style: AppStyle.txtInterRegular18.copyWith(color: darkTextColor),
          ),
                              ...
                              Expanded(
                                ...
                                child: Container(
                                    ...
                                    child: item[index]
                                            ...
                                            .isNotEmpty
                                        ? Image.network(
                                            '${item[index].danhsach[indexs].url}',
                                            height: 150,
                                          )
                                        : Icon(
                                            Icons.person,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    CustomRichText(
                                      textLeft: 'Họ và tên:',
                                      textRight:
                                          ' ${item[index].danhsach[indexs].TenSV}',
                                    ),
                                    CustomRichText(
                                      textLeft: 'Mã sinh viên:',
                                      textRight:
                                          ' ${item[index].danhsach[indexs].MaSV}',
                                    ),
                                    CustomRichText(
                                      textLeft: 'Khoa:',
                                      textRight:
                                          ' ${item[index].danhsach[indexs].Khoa}',
                                    ),
                                  ],
                                ),
                              )
            ...
            Expanded(
                ...
                child: Container(
                  ...
                  child: Scaffold(
                    ...
                    body: Obx(
                      () => controller.isLoadingConfig.value? controller.getConfigList.isNotEmpty
                          ? Container(
                              height: Get.height,
                              width: Get.width,
