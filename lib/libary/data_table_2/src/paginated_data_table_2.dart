...
class PaginatedDataTable2 extends StatefulWidget {
  ...
  PaginatedDataTable2({
    ...
    this.empty,
    this.border,
    this.colorFirstLastButtons = Colors.grey,
    this.colorNextPreviousButtons = Colors.grey,
  ...
  final Color colorFirstLastButtons;

  final Color colorNextPreviousButtons;
...
class PaginatedDataTable2State extends State<PaginatedDataTable2> {
  ...
  Widget _getFooter() {
    ...
    if (widget.onRowsPerPageChanged != null) {
      ...
      if (!widget.autoRowsToHeight) {
        footerWidgets.addAll(<Widget>[
          ...
          Text(localizations.rowsPerPageTitle, style: TextStyle(color: Colors.black),),
          ConstrainedBox(
    ...
    //TungVD: Sửa text hiển thị kết quả đơn giản
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        Widget t = Column(
          ...
          children: <Widget>[
            ...
            if (!widget.hidePaginator) Container(
